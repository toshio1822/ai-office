...
def test_real_segment_synthetic_seam_delegates_once(tmp_path: Path, status: str) -> None:
    ...
    # Inline Phase 166 next-seam reference: the same persisted Phase-155
    # history is now accepted by real Phase 79 and delegated exactly once to a
    # synthetic Phase 72 seam, and real Phase 58 now accepts it too and
    # delegates exactly once to a synthetic Phase 51 seam, proving the Phase 166
    # fallback reaches Phase 51.
