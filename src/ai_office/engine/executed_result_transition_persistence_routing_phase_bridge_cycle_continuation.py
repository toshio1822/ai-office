...
def route_executed_result_transition_persistence_routing_phase_bridge_cycle_continuation(
    ...
    *,
    ...
    _top_level(result, workflow, state_path, events_path, phase71_function)
    ...
    try:
        value = phase71_function(result, workflow, state_path, events_path)
    except ExecutedResultTransitionPersistenceRoutingPhaseBridgeContinuationError as error:
    ...
    except ExecutedResultTransitionPersistenceRoutingPhaseBridgeCycleContinuationCompatibilityError as error:
