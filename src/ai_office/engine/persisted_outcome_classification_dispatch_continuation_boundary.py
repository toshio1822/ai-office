...
class PersistedOutcomeClassificationDispatchContinuationCompatibilityError(PersistedOutcomeClassificationDispatchContinuationError):
    def __init__(self, classification: Classification) -> None:
        super().__init__("persisted outcome classification dispatch continuation inputs are incompatible")
        self.detail = PersistedOutcomeClassificationDispatchContinuationFailureDetail(classification)
...
def route_persisted_outcome_classification_dispatch_continuation_boundary(
    ...
    phase93_function: Phase93Function = route_persisted_outcome_classification_dispatch_phase_bridge_cycle_reentry_continuation,
    ...
    except PersistedOutcomeClassificationDispatchPhaseBridgeCycleReentryContinuationError as error:
