...
class RuntimeResultTransitionPersistenceCycleReentryContinuationFailureDetail:
    classification: Classification


class RuntimeResultTransitionPersistenceCycleReentryContinuationError(
    ValueError
):
    """Raised when Phase 113 cannot safely continue the supplied result."""


class RuntimeResultTransitionPersistenceCycleReentryContinuationCompatibilityError(
    ...
    def __init__(self, classification: Classification) -> None:
        ...
        self.detail = RuntimeResultTransitionPersistenceCycleReentryContinuationFailureDetail(
            classification
        )


def route_runtime_result_transition_persistence_cycle_reentry_continuation_boundary(
    result: object,
    workflow: object,
    state_path: object,
    events_path: object,
    *,
    phase106_function: Phase106Function = (
        route_runtime_result_transition_persistence_cycle_continuation_boundary
    ),
) -> (
    WorkflowExecutionPersistenceResult
    ...
    _top_level(result, workflow, state_path, events_path, phase106_function)
    ...
    try:
        value = phase106_function(result, workflow, state_path, events_path)
    except RuntimeResultTransitionPersistenceCycleContinuationError as error:
    ...
    except RuntimeResultTransitionPersistenceCycleReentryContinuationCompatibilityError as error:
...
def _raise(classification: Classification) -> None:
    raise RuntimeResultTransitionPersistenceCycleReentryContinuationCompatibilityError(
        classification
    ) from None
